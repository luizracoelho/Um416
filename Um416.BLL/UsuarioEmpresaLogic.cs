...
namespace Um416.BLL
{
    public class UsuarioEmpresaLogic : BaseLogic<UsuarioEmpresa, UsuarioEmpresaRepository>, IUsuarioLogic
    {
        Crypt _crypt;

        public UsuarioEmpresaLogic()
        {
            _crypt = new Crypt();
        }

        public override IEnumerable<UsuarioEmpresa> List()
        {
            return base.List().OrderBy(x => x.Nome);
        }

        public override IEnumerable<UsuarioEmpresa> List(Expression<Func<UsuarioEmpresa, bool>> predicate)
        {
            return base.List(predicate).OrderBy(x => x.Nome);
        }

        protected override void Insert(UsuarioEmpresa entity)
        {
        ...
        protected override void Update(UsuarioEmpresa entity)
        {
        ...
        public override void Save(UsuarioEmpresa entity)
        {
        ...
        public UsuarioEmpresa GetAuthenticatedUser(string login, string senha)
        {
